    ...
    public sealed class BinaryExpression : Expression
    {
        ...
        public static BinaryOperator ParseBinaryOperator(string op)
        {
            switch(op)
            {
                ...
                case "===" : return BinaryOperator.StrictlyEqual;
                case "!==" : return BinaryOperator.StricltyNotEqual;
                ...
                case ">>>" : return BinaryOperator.UnsignedRightShift;
                case "instanceof" : return BinaryOperator.InstanceOf;
                case "in" : return BinaryOperator.In;
                case "&&" : return BinaryOperator.LogicalAnd;
                case "||" : return BinaryOperator.LogicalOr;
                case "**" : return BinaryOperator.Exponentiation;
                default : return ThrowArgumentOutOfRangeException<BinaryOperator>(nameof(op), "Invalid binary operator: " + op);
            };
        }
