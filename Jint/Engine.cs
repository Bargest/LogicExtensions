...
namespace Jint
{
    public class ThreadLocal<T>
    {
        // Crutch! Leaks!
        Func<T> Factory;
        Dictionary<System.Threading.Thread, T> values = new Dictionary<System.Threading.Thread, T>();
        ...
        public T GetValue()
        {
            lock (values)
            {
                if (!values.ContainsKey(System.Threading.Thread.CurrentThread))
                    values[System.Threading.Thread.CurrentThread] = Factory();
                return values[System.Threading.Thread.CurrentThread];
            }
        }
    ...
    public class Engine : IDisposable
    {
        ...
        public ErrorConstructor Error => _error == null ? _error = ErrorConstructor.CreateErrorConstructor(this, _errorFunctionName) : _error;
        public ErrorConstructor EvalError => _evalError == null ? _evalError = ErrorConstructor.CreateErrorConstructor(this, _evalErrorFunctionName) : _evalError;
        public ErrorConstructor SyntaxError => _syntaxError == null ? _syntaxError = ErrorConstructor.CreateErrorConstructor(this, _syntaxErrorFunctionName) : _syntaxError;
        public ErrorConstructor TypeError => _typeError == null ? _typeError = ErrorConstructor.CreateErrorConstructor(this, _typeErrorFunctionName) : _typeError;
        public ErrorConstructor RangeError => _rangeError == null ? _rangeError = ErrorConstructor.CreateErrorConstructor(this, _rangeErrorFunctionName) : _rangeError;
        ...
        internal DebugHandler DebugHandler => _debugHandler == null ? _debugHandler = new DebugHandler(this) : _debugHandler;

        public List<BreakPoint> BreakPoints => _breakPoints == null ? _breakPoints = new List<BreakPoint>() : _breakPoints;
