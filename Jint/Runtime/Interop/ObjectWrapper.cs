...
namespace Jint.Runtime.Interop
{
	...
	public sealed class ObjectWrapper : ObjectInstance, IObjectWrapper
    {
        ...
        {
            Target = obj;
            // TODO: this breaks CLR intergration
            /*
            ...
            if (ObjectIsArrayLikeClrCollection(type))
            {
                ...
                IsArrayLike = true;
                var functionInstance = new ClrFunctionInstance(engine, "length", (thisObj, arguments) => JsNumber.Create((int) lengthProperty.GetValue(obj, null)));
